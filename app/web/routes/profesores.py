...
def listar():
    ...
    profesores = listar_profesores(session, solo_activos=False, texto=texto)
    return render_template("profesores/list.html", profesores=profesores, texto=texto)
...
def detalle(profesor_id):
    ...
    return render_template(
        "profesores/detalle.html", profesor=profesor, direcciones=direcciones, membresias=membresias
    )
