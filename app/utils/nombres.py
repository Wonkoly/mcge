...
Ver el problema real documentado en 'MaestriaGeofisica - Excel Alumnos
(Mapeo de Hojas)': 53 variantes de texto para un número menor de personas
reales (prefijos Dr./Dra./Mtro., typos de acentos, saltos de línea)."""
